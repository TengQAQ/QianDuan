  ...
  <div class="app-container">
    ...
    <el-form :model="queryParam" ref="queryForm" size="small" :inline="true">
      <el-form-item label="分类名称" prop="name">
        <el-input v-model="queryParam.name" placeholder="请输入分类名称" clearable style="width: 240px" @keyup.enter.native="handleQuery"/>
      </el-form-item>
    ...
    <el-table :data="tableData.rows" border style="width: 100%" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="分类图片" width="220">
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body :close-on-click-modal="false" :before-close="cancelForm">
      <el-form ref="form" :model="form" label-width="100px">
        <el-form-item label="分类名称" prop="name" :rules="[  { required: true, message: '该值不能为空', trigger: 'blur' }]">
          <el-input v-model="form.name" placeholder="请输入分类名称(唯一)"/>
        </el-form-item>

        <el-form-item label="分类图片" prop="picture" :rules="[  { required: true, message: '该值不能为空', trigger: 'blur' }]">
...
import { dataApi, addApi, editApi, findByIdApi, downloadExcel } from '@/api/category.js'
